...
1. [Coding Standards](#coding-standards)
   - [NO phpcs:ignore Comments](#1-no-phpcsignore-comments)
   - [WordPress Coding Standards Compliance](#2-wordpress-coding-standards-compliance)
   - [Security First](#3-security-first)
   - [ALWAYS Sanitize Input Fields](#3a-always-sanitize-input-fields)
   - [Escape ALL Output](#3b-escape-all-output-except-code-fields)
   - [Prefix All PHP Variables](#4-prefix-all-php-variables-where-required)
   - [NO Direct SQL Writing](#5-no-direct-sql-writing)
   - [File Structure](#6-file-structure)
   - [Testing](#7-testing)
   - [Comments](#8-comments)
   - [File Upload Validation](#9-file-upload-validation)
   - [Nonce Verification](#10-nonce-verification)
   - [Capability Checks](#11-capability-checks)
   - [Array Access Safety](#12-array-access-safety)
   - [WordPress Functions Over PHP](#13-wordpress-functions-over-php)
   - [Error Handling](#14-error-handling)
   - [Dependencies](#15-dependencies)
   - [Consistent User Feedback](#16-consistent-user-feedback)
